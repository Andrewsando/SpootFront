      ...
      <div className="bg-black text-white font-sans text-lg">
        <div className="bg-Team">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:items-start lg:justify-between p-7 my-20 ">
            <div className="lg:w-1/2 lg:mr-10 mx-auto mt-6">
        ...
        <div ref={teamSection}>
          <section>
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
              ...
              <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div className="items-center bg-[#166534] rounded-lg shadow sm:flex dark:bg-[#166534]dark:border-200">
                  <a href="#">
                    <img
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-3 mb-4 font-light text-black dark:text-black">
                ...
                <div className="items-center bg-[#166534] rounded-lg shadow sm:flex dark:bg-[#166534]dark:border-gray-700">
                  <a href="#">
                    <img
                      className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
                ...
                <div className="items-center bg-[#166534] rounded-lg shadow sm:flex dark:bgbg-[#166534]dark:border-gray-700">
                  <a href="#">
                    <img
                      className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
                ...
                <div className="items-center bg-[#166534] rounded-lg shadow sm:flex dark:bg-[#166534]dark:border-gray-700">
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-3 mb-4 font-light text-black dark:text-black">
                      Lana drives the technical strategy of the flowbite
                      platform and brand.
                    </p>
                    <ul className="flex space-x-4 sm:mt-0">
                      <li>
                ...
                <div className="items-center bg-[#166534] rounded-lg shadow sm:flex dark:bg-[#166534] dark:border-gray-200">
                  <a href="#">
                    <img
                      className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
                      src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
          ...
          <div className="my-2 mx-80 mb-32">
            ...
            <div className="grid gap-6 grid-cols-2">
              <a
                href="#"
                className="grid max-w-sm p-6 bg-[#16A34A] border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-[#16A34A] dark:border-black dark:hover:bg-[#22C55E]"
              >
                <h5 className="mb-2 text-2xl text-center font-bold tracking-tight text-gray-900 dark:text-white">
                  Diseño del producto
                </h5>
                <p className="font-normal text-black-700 dark:text-black">
                Los diseñadores de productos de SpootChat se esfuerzan por brindar la mejor experiencia posible a oyentes y creadores, haciendo que disfrutar de Spootchat sea fácil y personalizado.
                </p>
              </a>
              <a
                href="#"
                className="block max-w-sm p-6 bg-[#16A34A] border border-black rounded-lg shadow hover:bg-gray-100 dark:bg-[#16A34A] dark:border-black dark:hover:bg-[#22C55E]"
              >
                <h5 className="mb-2 text-2xl text-center font-bold tracking-tight text-gray-900 dark:text-white">
                Diseño editorial
                </h5>
                <p className="font-normal text-black dark:text-black">
                El diseño editorial en SpootChat crea marcas y experiencias para nuestra audiencia global, definiendo la cultura para nuestros oyentes en todo el mundo.
                </p>
              </a>
              <a
                href="#"
              ...
              >
                ...
                Nuestros expertos en herramientas internas construyen tecnología que permite a Spotify aprender y escalar rápidamente, apoyando nuestro crecimiento global de usuarios y negocios.
                </p>
              </a>
              <a
                href="#"
              ...
              >
                ...
                <p className="font-normal text-black dark:text-black">
                Design Ops mejora nuestra práctica y comunidad al simplificar el proceso de diseño y promover su disfrute, fortaleciendo herramientas, aprendizaje y cultura.
                </p>
              </a> 
            </div>
          </div>
