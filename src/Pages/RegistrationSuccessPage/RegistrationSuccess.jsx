            ...
            <div className='text-xl grid h-screen place-items-center text-white bg-gradient-to-r from-[#141921] to-[#000000]'>
                <div>
                    <div className='flex w-full justify-center items-center'>
                        <img src={logoImg} className='h-24 w-24' alt="SpootChat logo" />
                    </div>
                    ...
                    <div className='flex justify-center items-center'>
                        <Link to="/home">
                            <button className='my-8 bg-[#54E360] p-4 rounded-xl text-black font-bold shadow-xl'>Empezar ahora</button>
                        </Link>
                    </div>
                </div>
            </div>
