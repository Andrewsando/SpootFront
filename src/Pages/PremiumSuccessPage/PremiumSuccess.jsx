            ...
            <div className="text-white text-xl grid h-screen place-items-center p-4 bg-gradient-to-r from-[#141921] to-[#000000]">
                <div className="text-center">
                    <div className="flex w-full justify-center items-center">
                        <IconContext.Provider value={{ color: "#54E360", size: 80 }}>
                            <AiFillCheckCircle />
                    ...
                    <p className="">Gracias por tu compra y unirte a los <span className="font-bold">{count.toLocaleString()}</span> usuarios que confían en nosotros</p>
                    <p className="">Empieza a disfrutar de todos los beneficios de SpootChat premium <span className="underline underline-offset-4 decoration-[#54E360] font-bold">sin límite</span></p>
                    <Link to="/home">
